            ...
            <div className="legalAdvise-container">
                ...
                <div className="legalAdvise-textbox">
                    <div className="textbox">
                        ...
                        <ul>
                            <li>
                                <b>Este sitio web es titularidad de:</b>
                            </li>
                    ...
                    <div className="textbox">
                        ...
                        <p>
                            Todos los contenidos del sitio web (textos,
                            imágenes, diseños, logotipos, código fuente, etc.)
                            están protegidos por la normativa vigente sobre
                            propiedad intelectual. Queda prohibida su
                    ...
                    <div className="textbox">
                        ...
                        <p>
                            El titular no se responsabiliza del mal uso que se
                            realice del contenido del sitio web, ni de los daños
                            que puedan derivarse del uso de la información.
                        </p>
                    </div>
                    <div className="textbox">
                        <h2>Enlaces externos</h2>
                        <p>
                            Este sitio puede contener enlaces a páginas
                            externas. El titular no se responsabiliza del
                            contenido ni de la política de privacidad de dichas
                            páginas.
                        </p>
                    </div>
                    <div className="textbox">
                        ...
                        <p>
                            ...
                            derivarse, las partes se someten a los Juzgados y
