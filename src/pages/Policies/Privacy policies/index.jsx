                ...
                <main className="page" role="main" aria-labelledby="policy-title">
                    ...
                    <nav className="toc" aria-label="Índice de la Política de Privacidad">
                        <ul>
                            ...
                            <li><a href="#finalidad">Finalidad y base legal</a></li>
                    ...
                    <section id="intro">
                        <p>
                            En <strong>NOROBRA</strong> (en adelante, “la Empresa”) nos comprometemos a proteger su privacidad y a garantizar un tratamiento legítimo, transparente y seguro de sus datos personales, conforme al Reglamento (UE) 2016/679 (RGPD) y la Ley Orgánica 3/2018 (LOPDGDD).
                        </p>
                        <p>
                            Esta Política de Privacidad explica qué datos recopilamos, con qué finalidades, durante cuánto tiempo los conservamos, con quién los compartimos y cómo puede ejercer sus derechos.
                        </p>
                    </section>
                    ...
                    <section id="datos" aria-labelledby="h-datos">
                        ...
                        <ul>
                            <li><strong>Datos identificativos y de contacto:</strong> nombre, apellidos, dirección postal, correo electrónico y teléfono.</li>
                            <li><strong>Datos de navegación:</strong> dirección IP, páginas visitadas, tipo de navegador, dispositivo, fecha y hora de acceso.</li>
                            <li><strong>Datos de uso:</strong> información sobre cómo utiliza nuestros servicios o interacciona con el sitio web.</li>
                            <li><strong>Datos facilitados voluntariamente:</strong> información incluida en formularios, solicitudes de presupuesto o correspondencia.</li>
                        </ul>
                    </section>
                    ...
                    <section id="finalidad" aria-labelledby="h-finalidad">
                        ...
                        <ul>
                            <li><strong>Prestar y gestionar servicios:</strong> gestionar solicitudes, contratos, presupuestos y atención al cliente. <em>Base legal:</em> ejecución de contrato o actuaciones precontractuales.</li>
                            <li><strong>Comunicación comercial:</strong> envío de boletines, promociones y noticias (solo con su consentimiento). <em>Base legal:</em> consentimiento del interesado.</li>
                            <li><strong>Mejora del servicio:</strong> análisis y métricas para optimizar la experiencia en la web. <em>Base legal:</em> interés legítimo.</li>
                            <li><strong>Cumplimiento legal:</strong> conservación de facturas y obligaciones fiscales. <em>Base legal:</em> obligación legal.</li>
                        </ul>
                    </section>
                    ...
                    <section id="conservacion" aria-labelledby="h-conservacion">
                        ...
                        <p>
                            Para obligaciones contables o fiscales, sus datos se conservarán durante los plazos exigidos por la normativa aplicable.
                        </p>
                    </section>
                    ...
                    <section id="destinatarios" aria-labelledby="h-destinatarios">
                        ...
                        <ul>
                            <li>Proveedores tecnológicos que prestan servicios (hosting, correo, plataformas de gestión).</li>
                            <li>Administraciones públicas cuando exista obligación legal.</li>
                            <li>Proveedores de servicios de análisis y marketing (p.ej. Google Analytics), siempre con las garantías apropiadas.</li>
                        </ul>
                        <p>
                            En caso de transferencias internacionales fuera del Espacio Económico Europeo, adoptaremos las garantías exigidas por la normativa (cláusulas contractuales tipo, decisiones de adecuación, etc.) y se lo comunicaremos cuando proceda.
                        </p>
                    </section>
                    ...
                    <section id="derechos" aria-labelledby="h-derechos">
                        ...
                        <ul>
                            ...
                            <li><strong>Limitación del tratamiento:</strong> solicitar la restricción del tratamiento en ciertos supuestos.</li>
                    ...
                    <footer>
                        <p>© <strong>NOROBRA</strong> — Todos los derechos reservados.</p>
                    </footer>
                </main>
            </div>
            <Footer />
