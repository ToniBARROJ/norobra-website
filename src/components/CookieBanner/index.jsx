                ...
                <div className="cookie-consent">
                    <div className="cookie-container">
                        <p>
                            ...
                            para analizar el tráfico y personalizar el
                            contenido. Puedes consultar nuestra{" "}
                            <Link id="link" to="/cookiePolicies">
                                política de cookies
                            </Link>{" "}
                            para más información y configurar tus preferencias.
                        </p>
